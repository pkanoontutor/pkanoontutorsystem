...
urlpatterns = [
    ...
    path("tutor-sheets/markup/<int:document_id>/", views.tutor_sheet_markup_list, name="tutor_sheet_markup_list"),
    path("tutor-sheets/markup/<int:document_id>/<int:page>/", views.tutor_sheet_markup_save, name="tutor_sheet_markup_save"),
    ...
    path("course-renewal-notices/<int:pk>/attendance-card/", views.course_renewal_notice_attendance_card, name="course_renewal_notice_attendance_card"),
